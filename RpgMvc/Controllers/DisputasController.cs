    ...
    public class DisputasController : Controller
    {
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://localhost:5270/Personagens/GetHabilidades";
                //string uriBuscaPersonagens = "http://DanMarzo.somee.com/RpgApi/Personagens/GetHabilidades";
                //string uriBuscaPersonagens = "https://bsite.net/luizfernando987/Personagens/GetHabilidades";
